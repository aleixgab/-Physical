...
void ModulePhysics3D::AddConstraint(PhysBody3D &bodyA, PhysBody3D &bodyB, const btVector3 &pa, const btVector3 &pb) {

	btPoint2PointConstraint* constraint = new btPoint2PointConstraint(*bodyA.body,*bodyB.body, pa, pb);	world->addConstraint(constraint);	Constraints.add(constraint);}
