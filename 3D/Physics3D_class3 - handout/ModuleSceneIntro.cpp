...
bool ModuleSceneIntro::Start()
{
	...
	App->camera->Move(vec3(1.0f, 1.0f, 5.0f));
...
update_status ModuleSceneIntro::Update(float dt)
{
	...
	// physics one
	for (p2List_item<PhysBody3D*>* iter_body = App->physics->bodyList.getFirst(); iter_body != nullptr; iter_body = iter_body->next)
	{
