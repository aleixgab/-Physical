...
bool ModulePhysics3D::CleanUp()
{
	...
	for (p2List_item<btCollisionShape*>* iter_Coll = collisionList.getFirst(); iter_Coll != nullptr; iter_Coll = iter_Coll->next)
	{
		delete iter_Coll->data;
	}

	for (p2List_item<PhysBody3D*>* iter_body = bodyList.getFirst(); iter_body != nullptr; iter_body = iter_body->next)
	{
		delete iter_body->data;
	}
